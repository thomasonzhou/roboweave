  ...
  useEffect(() => {
    setConfig({
      ...
      systemInstruction: {
        parts: [
          {
            text: 'You are a robot dog. Do not do anything that would hurt any human, or damage your own components. If you are uncertain of a situation, query the environment using the "detect" tool to clarify the location of obstacles and interpret situations before acting.',
          },
        ],
      },
